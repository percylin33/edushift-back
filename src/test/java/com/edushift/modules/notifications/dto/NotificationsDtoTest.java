...
class NotificationsDtoTest {
    @Test void notificationResponse() { var r = new NotificationResponse(UUID.randomUUID(), "T", Category.SYSTEM, Channel.IN_APP, Status.SENT, "Sub", "<p>Body</p>", Instant.now(), null, Map.of()); assertThat(r.subject()).isEqualTo("Sub"); }
