...
class RubricControllerTest {
    ...
    class ListRubrics {
        ...
        @DisplayName("happy path ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 200 with array")
    ...
    class ListSystem {
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("happy path ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 200 with system seed")
        void happyPath() throws Exception {
    ...
    class GetRubric {
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("unknown ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ 404")
    ...
    class CreateRubric {
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("happy path ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 201")
        void happyPath() throws Exception {
            UUID id = UUID.randomUUID();
            ...
            mockMvc.perform(post("/v1/academic/rubrics")
                            ...
                            .content(objectMapper.writeValueAsString(validCreateRequest())).with(csrf()))
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("invalid shape ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 400 (validation)")
        void invalidShape() throws Exception {
            ...
            given(service.createRubric(any()))
                    .willThrow(new BadRequestException("RUB_CRITERIA_WEIGHT_SUM", "sum must be 100"));

            mockMvc.perform(post("/v1/academic/rubrics")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(bad)).with(csrf()))
                    .andExpect(status().isBadRequest())
                    .andExpect(jsonPath("$.errors[0].code").value("RUB_CRITERIA_WEIGHT_SUM"));

            then(service).should().createRubric(any());
        }

        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("name collision ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ 409 RUB_NAME_EXISTS")
    ...
    class ForkRubric {
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("happy path ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 201, body is optional")
        void happyPath() throws Exception {
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("non-system source ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ 400 RUB_CANNOT_FORK_NON_SYSTEM")
        void nonSystem() throws Exception {
            UUID source = UUID.randomUUID();
            given(service.forkRubric(eq(source), any()))
                    .willThrow(new BadRequestException("RUB_CANNOT_FORK_NON_SYSTEM", "no fork"));

            mockMvc.perform(post("/v1/academic/rubrics/{u}/fork", source)
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("{}").with(csrf()))
                    .andExpect(status().isBadRequest())
                    .andExpect(jsonPath("$.errors[0].code").value("RUB_CANNOT_FORK_NON_SYSTEM"));
        }
    }
    ...
    class UpdateRubric {
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("happy path ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 200")
        void happyPath() throws Exception {
            UUID id = UUID.randomUUID();
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("system rubric ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ 403 RUB_SYSTEM_READ_ONLY")
    ...
    class DeleteRubric {
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("happy path ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 204")
        void happyPath() throws Exception {
            UUID id = UUID.randomUUID();
            willDoNothing().given(service).deleteRubric(id);

            mockMvc.perform(delete("/v1/academic/rubrics/{u}", id).with(csrf()))
        ...
        @Test
        @WithMockUser(roles = "TENANT_ADMIN")
        @DisplayName("system rubric ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ 403")
        void systemReadOnly() throws Exception {
            UUID id = UUID.randomUUID();
