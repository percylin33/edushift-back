...
/**
 * Payload of {@code PUT /v1/academic/competencies/{publicUuid}}.
 *
 * <p>Partial-merge: {@code null} fields are ignored. To change the
 * relative order use {@code PATCH /v1/academic/courses/{courseUuid}/competencies/reorder}
 * (see {@link CompetencyReorderRequest}); {@code displayOrder} is
 * intentionally NOT exposed here to avoid duplicate-ordinal races.</p>
 */
